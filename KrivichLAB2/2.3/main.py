...
def dll_work(_item):
    ...
    try:
        ctypes.CDLL(os.path.join(r'C:\Users\Николай\Desktop\KrivichLAB2\2.3\dll', _item))
    except OSError:
...
def dll_connection(_item):
    ...
    return ctypes.CDLL(os.path.join(r'C:\Users\Николай\Desktop\KrivichLAB2\2.3\dll', _item))
